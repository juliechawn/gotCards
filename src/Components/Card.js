...
class Card extends Component {
  ...
  renderBack() {
    return(
    <div className="card-back" onClick={() => this.setState({ toggle: !this.state.toggle })}>
      <div className="char-title">
      ...
      <tbody>
        <tr>
          <td>{this.props.spouse} <span className="spouse-status">{this.props.spousestatus}</span></td>
